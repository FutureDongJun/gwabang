      ...
      <div className="min-h-screen flex bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white">
        ...
        <aside className="w-64 p-6 bg-white dark:bg-[#1E2028] shadow-md">
          ...
          <ul className="space-y-2 text-sm">
            <li className="flex justify-between">화학공학과 <span className="text-gray-400">77,506명</span></li>
            <li className="flex justify-between">컴퓨터공학과 <span className="text-gray-400">70,457명</span></li>
            <li className="flex justify-between">심리학과 <span className="text-gray-400">68,798명</span></li>
        ...
        <section className="flex-1 p-10">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-8">전공 학과별로 정보를 공유하고 소통할 수 있는 대학생 전용 커뮤니티 플랫폼이에요!</p>
          
          <div className="grid mb-4 grid-rows-2 gap-6">
            <div className="p-6 bg-white dark:bg-[#2A2C36] rounded-xl shadow">시험 정보 카드</div>
            <div className="p-6 bg-white dark:bg-[#2A2C36] rounded-xl shadow">강의실 대화 카드</div>
          </div>
